...
import { Download, Eye, Mail, BarChart3, Database, FileCode2, Sheet, Sparkles, Building2, Linkedin, Github, Phone } from 'lucide-react';
    ...
    >
      ...
      >
        ...
        <div className="text-left">
          <p className="text-[10px] uppercase tracking-wider text-slate-500 dark:text-slate-400 font-extrabold">BI Tool</p>
          <p className="text-xs sm:text-sm font-extrabold text-slate-900 dark:text-white">Power BI</p>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="text-left">
          <p className="text-[10px] uppercase tracking-wider text-slate-500 dark:text-slate-400 font-extrabold">Database</p>
          <p className="text-xs sm:text-sm font-extrabold text-slate-900 dark:text-white">SQL</p>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="text-left">
          <p className="text-[10px] uppercase tracking-wider text-slate-500 dark:text-slate-400 font-extrabold">Code</p>
          <p className="text-xs sm:text-sm font-extrabold text-slate-900 dark:text-white">Python</p>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="text-left">
          <p className="text-[10px] uppercase tracking-wider text-slate-500 dark:text-slate-400 font-extrabold">Spreadsheet</p>
          <p className="text-xs sm:text-sm font-extrabold text-slate-900 dark:text-white">Excel</p>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 mt-3 mb-4">
          <span className="px-2.5 py-1 rounded-lg bg-yellow-500/10 dark:bg-yellow-500/20 border border-yellow-500/30 text-yellow-700 dark:text-yellow-300 text-xs font-bold flex items-center gap-1">
            <BarChart3 className="w-3.5 h-3.5 text-yellow-500" /> Power BI
          </span>
          <span className="px-2.5 py-1 rounded-lg bg-blue-500/10 dark:bg-blue-500/20 border border-blue-500/30 text-blue-700 dark:text-blue-300 text-xs font-bold flex items-center gap-1">
            <Database className="w-3.5 h-3.5 text-blue-500" /> SQL
          </span>
          <span className="px-2.5 py-1 rounded-lg bg-sky-500/10 dark:bg-sky-500/20 border border-sky-400/30 text-sky-700 dark:text-sky-300 text-xs font-bold flex items-center gap-1">
            <FileCode2 className="w-3.5 h-3.5 text-sky-400" /> Python
          </span>
          <span className="px-2.5 py-1 rounded-lg bg-emerald-500/10 dark:bg-emerald-500/20 border border-emerald-500/30 text-emerald-700 dark:text-emerald-300 text-xs font-bold flex items-center gap-1">
            <Sheet className="w-3.5 h-3.5 text-emerald-500" /> Excel
          </span>
        </div>
  ...
  return (
    <section id="home" className="relative min-h-screen pt-28 pb-16 flex flex-col justify-center overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10 my-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <div className="h-10 sm:h-12 flex items-center mb-4">
              <span className="text-xl sm:text-3xl font-bold text-slate-800 dark:text-slate-200 font-outfit">
                {displayText}
              </span>
        ...
        {/* Target Companies Ticker / Banner */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.6, duration: 0.6 }}
          className="mt-16 pt-8 border-t border-slate-200/80 dark:border-slate-800/80"
        >
          <p className="text-center text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 mb-4 flex items-center justify-center gap-2">
            <Building2 className="w-4 h-4 text-blue-600 dark:text-sky-400" />
            <span>Targeting Data Internship Opportunities At Top Firms</span>
          </p>

          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 max-w-5xl mx-auto">
            {PORTFOLIO_DATA.personal.targetCompanies.map((comp) => (
              <div
                key={comp.name}
                className="px-3.5 py-1.5 rounded-xl bg-slate-200/60 dark:bg-slate-900/60 border border-slate-300/80 dark:border-slate-800 text-xs font-bold text-slate-700 dark:text-slate-300 hover:text-blue-600 dark:hover:text-sky-400 hover:border-blue-500/40 transition-colors shadow-sm"
              >
                {comp.name}
              </div>
            ))}
